codeunit 50028 "ShowResponseMessage Meth"
{
    procedure ShowResponseMessage(var Log: Record "Http Log");
    var
        Handled: Boolean;
    begin
    ...
    local procedure DoShowResponseMessage(var Log: Record "Http Log"; var Handled: Boolean);
    var
        Instr: Instream;
    ...
    local procedure OnBeforeShowResponseMessage(var Log: Record "Http Log"; var Handled: Boolean);
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterShowResponseMessage(var Log: Record "Http Log");
    begin
    end;
}